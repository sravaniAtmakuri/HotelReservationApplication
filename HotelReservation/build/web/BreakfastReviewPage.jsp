...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <meta charset="UTF-8">
            <title> Breakfast Review Page</title>
                                ...
                                <fieldset class="row1">
                                    ...
                                    <table  style="width:60%" cellspacing="0" cellpadding="0" align="center">
                                        ...
                                        %>
                                          ...
                                          <tr>
                                              <td style="color: #000" width="20%" align="left"><div><%=bean.getBType()%></div></td>
<!--                                              <td style="color: #000" width="20%" align="left"><div></div></td>
                                              <td style="color: #000" width="20%" align="left"><div></div></td>-->
                                               <td style="color: #000" width="20%" align="left"><div><%=bean.getCheckInDate()%></div></td>
                                               <td style="color: #000" width="20%" align="left"><div><a href="BreakfastReviewConfirmation.jsp?hotelID=<%=bean.getHotelID()%>&BType=<%=bean.getBType()%>&CID=<%=bean.getCID()%>&checkInDate=<%=bean.getCheckInDate()%>"/></div>Review Breakfast</td>
