...
System.out.println(str.substring(0,str.length()-1)+"\t");
    ...
    System.out.println("hotel ID retrieved is : "+hotelIDString+"invoicenumber is "+InvoiceNo);
    session.setAttribute("InvoiceNo", InvoiceNo);
    session.setAttribute("hotelID", hotelIDString);
    int hotelID=Integer.parseInt(hotelIDString);
    List<ServiceBean> list1;
    List<BreakfastBean> list2;
    list1=service.retrieveServiceDetails(hotelID);
    list2=service.retrieveBreakfastDetails(hotelID);
    List<Room_ReservationBean> list=(List<Room_ReservationBean>) session.getAttribute("RoomReservationlist");
        ...
        <div class="modal-header">
         ...
         <form class="form-horizontal" name="ServiceReservation" id="ServiceReservation" action="ServiceReservationServlet" method="get" onsubmit="">
             <div class="modal-body modal-lg" >
                                    ...
                                    <table  style="width:50%" cellspacing="0" cellpadding="0">
                                        ...
                                        <%
                                            for (int i = 0; i < list1.size(); i++) {
                                                ...
                                                ServiceBean bean = list1.get(i);
                                                
                                        %>
                                        
                                          <tr>
                                              <td style="color: #000" width="50%" align="left" ><input type="checkbox"name="Soption" id="Soption" value="<%=bean.getSType()%>,<%=bean.getSPrice()%>">&nbsp;&nbsp;&emsp;<%=bean.getSType()%></td>
                                              <td style="color: #000" width="50%" align="left"><div><%=bean.getSPrice()%>&nbsp;$</div></td>
                 ...
                 <input type="submit" align="center" class="btn btn-block btn-lg btn-primary" value="Confirm and Book"/>
