...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <meta charset="UTF-8">
            <title>Room Review Confirmation Page</title>
   ...
   margin-top: -0px;
	...
	<ul class="nav navbar-nav">
	 <h4 class="navbar-text">Logged in as &nbsp;<%=session.getAttribute("userName") %></h4> 
             ...
             <ul class="nav navbar-nav navbar-right">
               ...
               <li><a href="loginPage.jsp">Service Review</a>
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h1 class="text-center">Room Review Information</h1>
        </div>
         <form class="form-horizontal" name="ServiceReservation" id="ServiceReservation" action="RoomReviewConfirmationServlet" method="get" onsubmit="">
             <div class="modal-body" align="left" >
                  <div class="form-inline">
                                               ...
                                               <table width="150%">
                         <tr>
                             <td style="color: #000" width="15%" align="left"> Hotel ID</td>
                             <td style="color: #000" width="100%" align="left"><%=hotelID%></td>
                         </tr>
                         <tr><td>&nbsp;</td>
                             <td>&nbsp;</td></tr>
                         <tr>
                             <td style="color: #000" width="15%" align="left"> Room No </td>
                             <td style="color: #000" width="100%" align="left"><%=RoomNo%></td>
                         </tr>
                          <tr><td>&nbsp;</td>
                              <td>&nbsp;</td></tr>
