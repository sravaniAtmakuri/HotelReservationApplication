...
<%@page import="bean.Room_ReviewBean"%>
...
System.out.println(str.substring(0,str.length()-1)+"\t");
    ...
    List<Room_ReviewBean> list=new ArrayList<Room_ReviewBean>();
    list=(List<Room_ReviewBean>)session.getAttribute("rlist");
 ...
 <div class="modal-dialog1">
    <div class="modal-content">
        <div class="modal-header">
            <h1 class="text-center">Room Type Ratings</h1>
        </div>
                                    ...
                                    <table  style="width:50%" cellspacing="0" cellpadding="0">
                                        ...
                                        <%
                                            for (int i = 0; i < list.size(); i++) {
                                                ...
                                                Room_ReviewBean bean = list.get(i);
                                                
                                        %>
                                        
                                          <tr>
                                              <td style="color: #000" width="50%" align="left" ><div><%=bean.getHotelID()%>&nbsp;</div></td>
                                              <td  font="arial-bold" size="13" style="color: #000" width="50%" align="left"><div> <%=bean.getRtype()%>&nbsp;</div></td>
