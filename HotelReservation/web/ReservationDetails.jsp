	 ...
	 <h4 class="navbar-text">Logged in as &nbsp;<%=session.getAttribute("userName") %></h4> 
             ...
             <ul class="nav navbar-nav navbar-right">
               ...
               <li><a href="loginPage.jsp">LOGOUT</a>
                                ...
                                <a href="ReservationDetails.jsp"></a>
                                        ...
                                        %>
                                          ...
                                          <tr>
                                              ...
                                              <td style="color: #000" width="10%">
                                                  <div><a href="BreakfastReservation.jsp?hotelID=<%=bean.getHotelID()%>&invoiceNo=<%=bean.getInvoiceNo() %>"/></div>Reserve Breakfast
                                                  <div><a href="ServiceReservation.jsp?hotelID=<%=bean.getHotelID()%>&invoiceNo=<%=bean.getInvoiceNo() %>"/></div>Reserve Service</td>
