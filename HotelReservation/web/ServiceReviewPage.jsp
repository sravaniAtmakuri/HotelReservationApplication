                                    ...
                                    <table  style="width:80%" cellspacing="0" cellpadding="0">
                                        ...
                                        <%
                                            for (int i = 0; i < list.size(); i++) {
                                                ...
                                                Service_ReviewBean bean = list.get(i);
                                                
                                        %>
                                        
                                          <tr>
                                              <td style="color: #000" width="20%" align="left"><div><%=bean.getSType()%></div></td>
                                              <td style="color: #000" width="20%" align="left"><div><%=bean.getCID()%></div></td>
                                              <td style="color: #000" width="20%" align="left"><div><%=bean.getHotelID()%></div></td>
                                               <td style="color: #000" width="20%" align="left"><div><%=bean.getCheckInDate()%></div></td>
                                               <td style="color: #000" width="20%" align="left"><div><a href="ServiceReviewConfirmation.jsp?hotelID=<%=bean.getHotelID()%>&SType=<%=bean.getSType()%>&CID=<%=bean.getCID()%>&checkInDate=<%=bean.getCheckInDate()%>"/></div>Review Service</td>
